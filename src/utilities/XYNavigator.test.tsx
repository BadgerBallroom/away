...
describe("XYNavigator", () => {
    ...
    beforeEach(() => {
        ...
        xyNavigator = new XYNavigator(locationClassName, horizontalNavigationAncestorClassName, topAncestor);
    });
    ...
    describe("moving up and down", () => {
        ...
        test("with moving horizontally in between", () => {
            ...
            // However, because of the attempted horizontal movement, when we move back up to y=1, x should remain 2.
