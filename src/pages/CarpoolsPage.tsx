...
import CarpoolDepartureDialog from "../components/CarpoolDepartureDialog";
...
const CarpoolsPage: React.FC<CarpoolsPageProps> = ({ hideAutoGen }) => {
    ...
    >
        ...
        <CarpoolDepartureDialog carpoolState={carpoolWhoseDepartureToEdit} onClose={onCarpoolDepartureDialogClose} />
